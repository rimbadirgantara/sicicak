...
if ($id === null) {
  ...
  $get_info = get_info($get_data_by_id);  
}
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Info Absensi, <small><?= date('d F Y') ?></small></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <div class="card">
            <div class="card-header"><h5 class="card-title">Info Absensi</h5></div>
              <div class="card-body">
