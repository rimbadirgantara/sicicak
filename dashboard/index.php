    ...
    <div class="content">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
            <?php if (mysqli_affected_rows($con) > 0) { ?>
              <?php if ($row['absen_keluar'] === ''){ ?>
                <a onclick="return confirm('Lakukan Absensi Keluar?')" style="color: #000" href="ultraman.php?email=<?= $_SESSION["login"]["email"]; ?>&status=absen_keluar">
                  <div class="info-box">
