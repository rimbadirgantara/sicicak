...
$query_read = mysqli_query($con, "SELECT * FROM absensi_backup WHERE nama = '$nama'");
$get_all = get_all($query_read);
// var_dump($get_all); die;
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Riwayat Absensi, <small><?= date('d F Y') ?></small></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                  ...
                  <tbody>
                    ...
                    <?php foreach($get_all as $row): ?>
                      <tr>
                        ...
                        <td>
                          <a href="info_riwayat_absensi?id=<?= $row['id']; ?>" class="btn btn-sm btn-info">Info</a>
                        </td>
