  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Absen Hari Ini, <small><?= date('d F Y') ?></small></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col">
            <div class="card card-primary card-outline">
              <div class="card-header">
                ...
                <a class="btn btn-sm btn-danger" href="../admin/hapus_semua?action=hapus_semua_absen" onclick="return confirm('Yakin mau hapus semua data absen pak ? ')">Hapus Semua ?</a>
              ...
              <div class="card-body table-responsive p-0">
                  ...
                  <tbody>
                    ...
                    <?php foreach($get_all as $row): ?>
                      <tr>
                        ...
                        <td>
                          <a href="../admin/info?id=<?= $row['id']; ?>&action=info" class="btn btn-sm btn-info"><i class="fas fa-info-circle"></i></a>
                          <a href="../admin/hapus?id=<?= $row['id']; ?>&action=hapus_absen" class="btn btn-sm btn-danger" onclick="return confirm('Yakin Mau Hapus pak ?')"><i class="fas fa-trash-alt"></i></a>
                        </td>
           	...
           	<h5 class="card-title" style="font-size: 14px"><strong>Data akan terhapus secara otomatis jika sudah 24 jam</strong></h5>
          </div>
          <!-- /.col-md-6 -->
        </div>
        <!-- /.row -->
